...
if [[ "$SKIP_BUILD" -eq 0 ]]; then
  # Sync workspace symlinks under apps/desktop/node_modules/@t3tools before
  # tsdown runs. If a freshly added workspace devDep is missing here, tsdown
  # silently externalizes it into main.cjs and turbo caches the broken bundle.
  echo "→ Refreshing workspace install..."
  bun install
