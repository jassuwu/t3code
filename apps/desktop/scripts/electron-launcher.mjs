// This file mostly exists because we want dev mode to say "Jass Code (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Jass Code (Dev)" : "Jass Code (Alpha)";
